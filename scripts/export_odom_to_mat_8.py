...
def feedback_exporter():
  ...
  odom_topic_7 = "/robot_6/odom"
  odom_topic_8 = "/robot_7/odom"
  
  #topic_name = "/robot/move_base/teb_feedback" # define feedback topic here!

  rospy.Subscriber(odom_topic_1, Odometry, feedback_callback, 1, queue_size = 5) 
  rospy.Subscriber(odom_topic_2, Odometry, feedback_callback, 2, queue_size = 5) 
  rospy.Subscriber(odom_topic_3, Odometry, feedback_callback, 3, queue_size = 5) 
  rospy.Subscriber(odom_topic_4, Odometry, feedback_callback, 4, queue_size = 5) 
  rospy.Subscriber(odom_topic_5, Odometry, feedback_callback, 5, queue_size = 5) 
  rospy.Subscriber(odom_topic_6, Odometry, feedback_callback, 6, queue_size = 5) 
  rospy.Subscriber(odom_topic_7, Odometry, feedback_callback, 7, queue_size = 5) 
  rospy.Subscriber(odom_topic_8, Odometry, feedback_callback, 8, queue_size = 5) 
